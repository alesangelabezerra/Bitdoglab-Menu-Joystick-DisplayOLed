...
// Declaração de funções públicas para manipulação do display SSD1306
...
extern void ssd1306_draw_string(uint8_t *ssd, int16_t x, int16_t y, const char *string); // Ajustado para const char *
